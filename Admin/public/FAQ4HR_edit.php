...
$sql="UPDATE help SET Questions ='".$Questions ."',Answers ='".$Answers ."' WHERE ID='".$faqs."'LIMIT 1";
...
$Questions=$_POST['Questions'];
$Answers=$_POST['Answers'];
$sql="DELETE FROM help WHERE ID='".$faqs."' LIMIT 1";
...
<div style="margin-left:240px;" class="faq holder">
...
if(mysqli_num_rows($result)>0){
	while($row=mysqli_fetch_array($result)){
		...
		$Answers=$row['Answers'];
		echo '<div class="faqs"><form action="FAQ4HR_edit.php?faqs='.$ID.'" method="post"></div>'; 
		echo'<span><div>Question:<br><input type="text" name="Questions" size="220" value="'.$Questions.'"</div></span><br>';
		echo '<span><div>Answer:<input type="text" name="Answers" size="220" value="'.$Answers.'"</div></span><br><br>';
		echo '<Button class="btn btn-default"type="submit" name="delete" >Delete</Button>';
		echo '<Button class="btn btn-default" style="margin-left:20px;" type="submit" name="edit">Edit</Button></form><br><br>';
	}
}
	else
	{
		echo"there are no faq to edit";
	}
	?>
	</div>
</body>
