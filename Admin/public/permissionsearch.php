...
$query = "SELECT * FROM `permission` WHERE CONCAT(`ID`, `PhysicalAddress`,`FriendAddress`,`Html`) LIKE '%".$valueToSearch."%'";
...
<form style="margin-left:250px;"  action ="permissionsearch.php" method="post" >
