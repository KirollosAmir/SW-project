...
$query = "SELECT * FROM `storeinventory` WHERE CONCAT(`ID`, `StoreID`,`InventoryID`) LIKE '%".$valueToSearch."%'";

$search_result = filtertable($query);
}
else{
	$query = "SELECT * FROM `storeinventory`";
	$search_result= filtertable($query);
...
<form action ="storeinventorySearch.php" method="post" >
