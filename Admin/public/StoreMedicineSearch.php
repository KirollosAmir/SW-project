...
$query = "SELECT * FROM `storemedicine` WHERE CONCAT(`ID`, `MedicineID`,`StoreID`) LIKE '%".$valueToSearch."%'";

$search_result = filtertable($query);
}
else{
	$query = "SELECT * FROM `storemedicine`";
	$search_result= filtertable($query);
...
<form action ="StoreMedicineSearch.php" method="post" >
