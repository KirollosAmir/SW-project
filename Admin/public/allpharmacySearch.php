...
$query = "SELECT * FROM `allpharmacy` WHERE CONCAT(`ID`, `Name`, `Location`, `UserTypeID`) LIKE '%".$valueToSearch."%'";

$search_result = filtertable($query);
}
else{
	$query = "SELECT * FROM `allpharmacy`";
	$search_result= filtertable($query);
...
<form action ="allpharmacySearch.php" method="post" >
