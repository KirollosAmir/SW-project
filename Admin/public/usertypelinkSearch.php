...
$query = "SELECT * FROM `usertypelink` WHERE CONCAT(`ID`, `UserID`, `LinkID`) LIKE '%".$valueToSearch."%'";

$search_result = filtertable($query);
}
else{
	$query = "SELECT * FROM `usertypelink`";
	$search_result= filtertable($query);
...
<form style="margin-left:140px;" action ="usertypelinkSearch.php" method="post" >
