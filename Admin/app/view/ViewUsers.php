...
class ViewMovies extends View{
	...
	public function output(){
		$str = "";
			...
			echo"<form  onsubmit='return validateForm()' action='Users.php?action=insert' method='post'>";		
			...
			echo"	<td>FirstName</td>";
				echo"<td><input style='width:120px;' onkeypress='return a(event);' required='' maxlength='15' type='text' name='FirstName' ></td>";
			...
			echo"	<td>LastName</td>";
				echo"<td><input style='width:120px;' onkeypress='return a(event);' required='' maxlength='15' type='text' name='LastName' ></td>";
			...
			echo"	<td>DateOfBirth</td>";
				echo"<td><input style='width:140px;' type='date' name='DateOfBirth'  name='DateOfBirth' required='' onkeypress='return isInputNumber(event);'></td>";
			...
			echo"	<td>Gender</td>";
				echo"<td><input style='width:120px;' required='' onkeypress='return a(event);' maxlength='6' type='text' name='Gender' ></td>";
...
echo"</tr> ";
			...
			echo"<tr> ";
			echo"	<td>Email</td>";
				echo"<td><input style='width:120px;' required='' maxlength='30' type='email' name='Email' ></td>";
			...
			echo"	<td>Password</td>";
				echo"<td><input style='width:120px;' type='password' required='' onkeypress='return isInputNumber(event);' name='Password' ></td>";
	...
	$con = new mysqli("localhost", "root", "","pharmacy");
  	...
  	$result = mysqli_query($con,$sql);	
		...
		echo"<select style='width:120px;' name='UsetTypeID'>";
		...
		echo"</td>";
			...
			echo"	<td></td>";
			echo"	<td><input style='width:120px;' type='submit' name='submit' value='Submit'></td>";
			echo"</tr>";
	echo"</table>";
	echo"</form>";
...
<th>Delete</th>
		...
		foreach($this->model->getMovies() as $Movie){
			...
			$str.="<td>".$Movie->getFirstName() ."  </td> ";
			$str.="<td>" . $Movie->getLastName() ."</td> ";
			$str.="<td>" . $Movie->getDateOfBirth() ."</td> ";
			
			
			$str.="<td>".$Movie->getGender() ."  </td> ";
			$str.="<td>" . $Movie->getEmail() ."</td> ";
			$str.="<td>" . $Movie->getPassword() ."</td> ";
			
			$str.="<td>" . $Movie->getUsetTypeID() ."</td> ";
			$str.="<td>
			<a  class='fas fa-edit' href='Users.php?action=edit&id=".$Movie->getID()."'></a>

			</td>";
			$str.="<td>
			<a style='color:red;'  class='fas fa-trash-alt' href='Users.php?action=delete&id=".$Movie->getID()."'></a>
	...
	public function edit($id){
		...
		foreach($this->model->getMovies() as $Movie){
			if($Movie->getID()===$id) 	{
				$str.="<tr>";
				$str.="<form action='Users.php?action=editAction&id=".$Movie->getID()."' method='post'>";
				$str.="<td>".$Movie->getID() ."  </td> ";
				$str.="<td><input style='width:80px;' type='text' name='FirstName' value='".$Movie->getFirstName() ."'>  </td> ";
				$str.="<td><input style='width:80px;' type='text' name='LastName' value='". $Movie->getLastName() ."'></td> ";
				
				
				$str.="<td><input style='width:80px;' type='text' name='DateOfBirth' value='".$Movie->getDateOfBirth() ."'>  </td> ";
				$str.="<td><input style='width:80px;' type='text' name='Gender' value='". $Movie->getGender() ."'></td> ";
			
				
				
				$str.="<td><input style='width:150px;' type='text' name='Email' value='".$Movie->getEmail() ."'>  </td> ";
				$str.="<td><input style='width:80px;' type='text' name='Password' value='". $Movie->getPassword() ."'></td> ";
				
				$str.="<td><input style='width:80px;' type='text' name='UsetTypeID' value='". $Movie->getUsetTypeID() ."'></td> ";
				...
				$str.="<td><a class='fas fa-edit' href='Users.php?action=edit&id=".$Movie->getID()."'></a></td>";
				$str.="</tr>";
			}
		}
		$str.="</table>";
