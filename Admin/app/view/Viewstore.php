...
class ViewMovies extends View{
	...
	public function output(){
		...
		$con = new mysqli("localhost", "root", "","pharmacy");
				...
				echo"<form action='store.php?action=insert' method='post'>";		
                echo"<table style='margin-left:-30px;' class='table table-bordered'>";

						
			echo"<tr> ";
			echo"	<td>Name</td>";
				echo"<td><input style='width:120px;'  required='' maxlength='20' onkeypress='return a(event);' type='text' name='Name' ></td>";
				
		
						
		
			echo"	<td>NumberOFproduct</td>";
				echo"<td><input style='width:120px;' required='' maxlength='4' onkeypress='return isInputNumber(event);' type='text' name='NumberOFproduct' ></td>";
				
			
			
			
			echo"	<td>price</td>";
				echo"<td><input style='width:120px;' required='' maxlength='4' onkeypress='return isInputNumber(event);' type='text' name='price' ></td>";
	...
	$str.="<td>" . $Movie->getID() ."</td> ";
			...
			$str.="<td>".$Movie->getNumberOFproduct() ."  </td> ";
			$str.="<td>" . $Movie->getprice() ."</td> ";
			$str.="<td>".$Movie->getUserTypeID() ."  </td> ";
			$str.="<td>
			<a class='fas fa-edit' href='store.php?action=edit&id=".$Movie->getID()."'></a>
			</td>";
			$str.="<td>
			<a  style='color:red;'  class='fas fa-trash-alt' href='store.php?action=delete&id=".$Movie->getID()."'></a>
			</td>";
			$str.="</tr>";
		}
	...
	public function edit($id){
		...
		foreach($this->model->getMovies() as $Movie){
			if($Movie->getID()===$id) 	{
				$str.="<tr>";
				$str.="<form action='store.php?action=editAction&id=".$Movie->getID()."' method='post'>";
				$str.="<td>" . $Movie->getID() ."</td> ";
				$str.="<td><input style='width:80px;' type='text' name='Name' value='". $Movie->getName() ."'></td> ";
				$str.="<td><input style='width:80px;' type='text' name='NumberOFproduct' value='".$Movie->getNumberOFproduct() ."'>  </td> ";
				
				
				$str.="<td><input style='width:80px;' type='text' name='price' value='". $Movie->getprice() ."'></td> ";
			...
			$str.="<td>" . $Movie->getID() ."</td> ";
				...
				$str.="<td>" . $Movie->getprice() ."</td> ";
					$str.="<td>".$Movie->getUserTypeID() ."  </td> ";
				$str.="<td><a class='fas fa-edit' href='store.php?action=edit&id=".$Movie->getID()."'></a></td>";
				$str.="</tr>";
			}
		}
		$str.="</table>";
