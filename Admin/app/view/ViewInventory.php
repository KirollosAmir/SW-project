...
class ViewMovies extends View{
	...
	public function output(){
		...
		$str.="<table  style='margin-left:-30px;' class='table table-bordered' >";
			$str.="<tr>";
		$str.="<form name='myForm' onsubmit='return validation()' action='Inventory.php?action=insert' method='post'>";
		$str.="<td><input onkeypress='return a(event);' required='' maxlength='15'style='width:120px;' type='text' name='Name' placeholder='Enter Name'/></td>";
		$str.="<td><input style='width:120px;' type='text' onkeypress='return a(event);' required='' maxlength='40' name='Description' placeholder='Enter Description'/></td>";
		
		
		$str.="<td><input style='width:120px;' type='text' onkeypress='return a(event);' required='' maxlength='15' name='Type' placeholder='Enter Type'/></td>";
		$str.="<td><input style='width:120px;' type='text' onkeypress='return a(event);' required='' maxlength='14' name='Item' placeholder='Enter Item'/></td>";
		
		
		$str.="<td><input style='width:120px;' onkeypress='return isInputNumber(event);' required='' maxlength='4' type='text' name='number' placeholder='Enter number'/></td>";
		$str.="<td><input style='width:120px;' type='text' onkeypress='return isInputNumber(event);' required='' maxlength='4' name='cost' placeholder='Enter cost'/></td>";
		
	
		
		$str.="<td><input style='width:120px;' type='submit' value='Submit'/></td>";
		$str.="</form>";
		$str.="</tr>";
		$str.="</table>";
		...
		foreach($this->model->getMovies() as $Movie){
			...
			$str.="<td>" . $Movie->getDescription() ."</td> ";
			$str.="<td>" . $Movie->getTypee() ."</td> ";
			
			
			$str.="<td>".$Movie->getItem() ."  </td> ";
			$str.="<td>" . $Movie->getnumber() ."</td> ";
			$str.="<td>" . $Movie->getcost() ."</td> ";
			
			
			$str.="<td>
			<a class='fas fa-edit' href='Inventory.php?action=edit&id=".$Movie->getID()."'></a>
			</td>";
			$str.="<td>
			<a  style='color:red;'  class='fas fa-trash-alt' href='Inventory.php?action=delete&id=".$Movie->getID()."'></a>
			</td>";
			$str.="</tr>";
		}
	...
	public function edit($id){
		...
		foreach($this->model->getMovies() as $Movie){
			if($Movie->getID()===$id) 	{
				$str.="<tr>";
				$str.="<form action='Inventory.php?action=editAction&id=".$Movie->getID()."' method='post'>";
				$str.="<td>".$Movie->getID() ."  </td> ";
				$str.="<td><input style='width:80px;' type='text' name='Name' value='".$Movie->getName() ."'>  </td> ";
				$str.="<td><input style='width:80px;' type='text' name='Description' value='". $Movie->getDescription() ."'></td> ";
				
				
				$str.="<td><input style='width:80px;' type='text' name='Type' value='".$Movie->getTypee() ."'>  </td> ";
				$str.="<td><input style='width:80px;' type='text' name='Item' value='". $Movie->getItem() ."'></td> ";
				...
				$str.="<td><a class='fas fa-edit' href='Inventory.php?action=edit&id=".$Movie->getID()."'></a></td>";
				$str.="</tr>";
			}
		}
		$str.="</table>";
