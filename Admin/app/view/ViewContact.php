...
echo"<tr> ";
				echo"<td>Name</td>";
				echo"<td><input  style='width:120px;' onkeypress='return a(event);' required='' type='text' maxlength='20' required='' name='Name' ></td>";
			
			echo"	<td>Subject</td>";
				echo"<td><input  style='width:120px;' onkeypress='return a(event);' required='' type='text' name='Subject' ></td>";
				
			
			echo"	<td>comment</td>";
				echo"<td><input  style='width:120px;' onkeypress='return a(event);' required='' type='text' name='comment' ></td>";
	...
	echo"</form>";
		...
		foreach($this->model->getMovies() as $Movie){
			...
			$str.="<td>" . $Movie->getSubject() ."</td> ";
			$str.="<td>" . $Movie->getcomment() ."</td> ";
			
			
			$str.="<td>".$Movie->getUserTypeID() ."  </td> ";
			
			$str.="<td>
			<a class='fas fa-edit' href='Contacts.php?action=edit&id=".$Movie->getID()."'></a>
			</td>";
			$str.="<td>
			<a  style='color:red;' class='fas fa-trash-alt' href='Contacts.php?action=delete&id=".$Movie->getID()."'></a>
			</td>";
			$str.="</tr>";
		}
	...
	public function edit($id){
		...
		foreach($this->model->getMovies() as $Movie){
			if($Movie->getID()===$id) 	{
				$str.="<tr>";
				$str.="<form action='Contacts.php?action=editAction&id=".$Movie->getID()."' method='post'>";
					$str.="<td>".$Movie->getID() ."  </td> ";
				$str.="<td><input style='width:80px;' type='text' name='Name' value='".$Movie->getName() ."'>  </td> ";
				$str.="<td><input style='width:80px;' type='text' name='Subject' value='". $Movie->getSubject() ."'></td> ";
				
				
				$str.="<td><input style='width:80px;' type='text' name='comment' value='".$Movie->getcomment() ."'>  </td> ";
				...
				$str.="<td><a class='fas fa-edit' href='Contacts.php?action=edit&id=".$Movie->getID()."'></a></td>";
				$str.="</tr>";
			}
		}
		$str.="</table>";
