...
class ViewMovies extends View{
	...
	public function output(){
		...
		$str.="<table  style='margin-left:-30px;' class='table table-bordered' >";
			$str.="<tr>";
		$str.="<form onsubmit='return validation()' action='Cars.php?action=insert' method='post'>";
		$str.="<td><input style='width:120px;' onkeypress='return a(event);'  required='' type='text' name='Type' placeholder='Enter Type'/></td>";
		$str.="<td><input style='width:120px;'   required='' type='text' name='Model' placeholder='Enter Model'/></td>";
		
		
		$str.="<td><input style='width:140px;'  required='' type='date' name='DateOFEntery' placeholder='Enter DateOFEntery' required='' /></td>";
		$str.="<td><input style='width:120px;' onkeypress='return a(event);'  required='' type='text' name='Color' placeholder='Enter Color'/></td>";
		
		
		$str.="<td><input style='width:120px;'   required='' type='text' name='License' placeholder='Enter License'/></td>";
		...
		foreach($this->model->getMovies() as $Movie){
			...
			$str.="<td>" . $Movie->getModel() ."</td> ";
			$str.="<td>" . $Movie->getDateOFEntery() ."</td> ";
			
			
			$str.="<td>".$Movie->getColor() ."  </td> ";
			$str.="<td>" . $Movie->getLicense() ."</td> ";
			
			$str.="<td>
			<a class='fas fa-edit' href='Cars.php?action=edit&id=".$Movie->getID()."'></a>
			</td>";
			$str.="<td>
			<a  style='color:red;'  class='fas fa-trash-alt' href='Cars.php?action=delete&id=".$Movie->getID()."'></a>
			</td>";
			$str.="</tr>";
		}
	...
	public function edit($id){
		...
		foreach($this->model->getMovies() as $Movie){
			if($Movie->getID()===$id) 	{
				$str.="<tr>";
				$str.="<form action='Cars.php?action=editAction&id=".$Movie->getID()."' method='post'>";
				$str.="<td>".$Movie->getID() ."  </td> ";
				$str.="<td><input style='width:80px;' type='text' name='Type' value='".$Movie->getTypee() ."'>  </td> ";
				$str.="<td><input style='width:80px;' type='text' name='Model' value='". $Movie->getModel() ."'></td> ";
				
				
				$str.="<td><input style='width:80px;' type='text' name='DateOFEntery' value='".$Movie->getDateOFEntery() ."'>  </td> ";
				$str.="<td><input style='width:80px;' type='text' name='Color' value='". $Movie->getColor() ."'></td> ";
			
				
				
				$str.="<td><input style='width:150px;' type='text' name='License' value='".$Movie->getLicense() ."'>  </td> ";
				...
				$str.="<td><a class='fas fa-edit' href='Cars.php?action=edit&id=".$Movie->getID()."'></a></td>";
				$str.="</tr>";
			}
		}
		$str.="</table>";
