...
class ViewMovies extends View{
	...
	public function output(){
		...
		$str.="<table  style='margin-left:-30px;' class='table table-bordered' >";
			$str.="<tr>";
		$str.="<form action='permission.php?action=insert' method='post'>";
		$str.="<td><input style='width:120px;' type='text' name='PhysicalAddress' placeholder='Enter PhysicalAddress'/></td>";
		$str.="<td><input style='width:120px;' type='text' name='FriendAddress' placeholder='Enter FriendAddress'/></td>";
		$str.="<td><input style='width:120px;' type='text' name='Html' placeholder='Enter Html'/></td>";
		
	
		$str.="<td><input style='width:120px;' type='submit' value='insert'/></td>";
		$str.="</form>";
		$str.="</tr>";
		$str.="</table>";
		...
		foreach($this->model->getMovies() as $Movie){
			...
			$str.="<td>" . $Movie->getPhysicalAddress() ."</td> ";
			$str.="<td>".$Movie->getFriendAddress() ."  </td> ";
			$str.="<td>".$Movie->getHtml() ."  </td> ";
			$str.="<td>
			<a class='fas fa-edit' href='permission.php?action=edit&id=".$Movie->getID()."'></a>
			</td>";
			$str.="<td>
			<a  style='color:red;' class='fas fa-trash-alt' href='permission.php?action=delete&id=".$Movie->getID()."'></a>
			</td>";
			$str.="</tr>";
		}
	...
	public function edit($id){
		...
		foreach($this->model->getMovies() as $Movie){
			if($Movie->getID()===$id) 	{
				$str.="<tr>";
				$str.="<form action='permission.php?action=editAction&id=".$Movie->getID()."' method='post'>";
				$str.="<td>" . $Movie->getID() ."</td> ";
				$str.="<td><input style='width:80px;' required='' type='text' name='PhysicalAddress' value='". $Movie->getPhysicalAddress() ."'></td> ";
				$str.="<td><input style='width:80px;' required='' type='text' name='FriendAddress' value='".$Movie->getFriendAddress() ."'>  </td> ";
				
			
				$str.="<td><input style='width:500px;height:100px;' required='' type='text' name='Html' value='".$Movie->getHtml() ."'>  </td> ";
			...
			$str.="<td>" . $Movie->getID() ."</td> ";
				...
				$str.="<td><a class='fas fa-edit' href='permission.php?action=edit&id=".$Movie->getID()."'></a></td>";
				$str.="</tr>";
			}
		}
		$str.="</table>";
