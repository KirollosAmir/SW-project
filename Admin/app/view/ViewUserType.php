...
class ViewMovies extends View{
	...
	public function output(){
		...
		$str.="<tr>";
		$str.="<form action='UserType.php?action=insert' method='post'>";
		...
		foreach($this->model->getMovies() as $Movie){
			...
			$str.="<td>
			<a  class='fas fa-edit' href='UserType.php?action=edit&id=".$Movie->getID()."'></a>
				</td>";
				$str.="<td>
			<a style='color:red;' class='fas fa-trash-alt' href='UserType.php?action=delete&id=".$Movie->getID()."'></a>
			</td>";
	...
	public function edit($id){
		$str = "";
		$str.="<table style='margin-left:-30px;' class='table table-bordered' >";
		$str.="<tr><th>ID</th><th>Type</th><th>Edit</th></tr>";
		foreach($this->model->getMovies() as $Movie){
			if($Movie->getID()===$id) 	{
				$str.="<tr>";
				$str.="<form action='UserType.php?action=editAction&id=".$Movie->getID()."' method='post'>";
					$str.="<td>".$Movie->getID() ."  </td> ";
				$str.="<td><input style='width:120px;' type='text' name='Type' value='".$Movie->getFirstName() ."'>  </td> ";
				...
				$str.="<td><a class='fas fa-edit' href='UserType.php?action=edit&id=".$Movie->getID()."'></a></td>";
				$str.="</tr>";
			}
		}
		$str.="</table>";
