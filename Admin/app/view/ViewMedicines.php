...
<th>Delete</th></tr>";
		...
		foreach($this->model->getMovies() as $Movie){
			...
			$str.="<td>
			<a  class='fas fa-edit' href='medicines.php?action=edit&id=".$Movie->getID()."'></a>
			</td>";
           $str.="<td>
			<a style='color:red;'  class='fas fa-trash-alt' href='medicines.php?action=delete&id=".$Movie->getID()."'></a>
			</td>";
	...
	public function edit($id){
		...
		foreach($this->model->getMovies() as $Movie){
			if($Movie->getID()===$id) 	{
				...
				$str.="<td>".$Movie->getID() ."  </td> ";
				$str.="<td><input style='width:80px;' type='text' onkeypress='return a(event);' name='Name' value='".$Movie->getName() ."'>  </td> ";
				$str.="<td><input style='width:80px;' type='text'  name='Discription' value='". $Movie->getDiscription() ."'></td> ";
				
				
				$str.="<td><input style='width:80px;' type='text' onkeypress='return a(event);' name='Type' value='".$Movie->getTypee() ."'>  </td> ";
				$str.="<td><input style='width:80px;' type='text' onkeypress='return isInputNumber(event);' name='Cost' value='". $Movie->getCost() ."'></td> ";
			
				
				
				$str.="<td><input style='width:150px;' type='text' onkeypress='return isInputNumber(event);' name='Number' value='".$Movie->getNumber() ."'>  </td> ";
				...
				$str.="<td><a class='fas fa-edit' href='Medicines.php?action=edit&id=".$Movie->getID()."'></a></td>";
				$str.="</tr>";
			}
		}
		$str.="</table>";
